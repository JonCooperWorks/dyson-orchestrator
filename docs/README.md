...
| [Storage and Secrets](storage-and-secrets.md) | SQLite tables, artefact cache, state-file mirror, agent skill publication gate, local KMS v2 envelopes, secret scopes |
